...
export function handlePoolCreatedHelper(
  ...
  const whitelistedPools = ["0xac70bd92f89e6739b3a08db9b6081a923912f73d", "0xc6962004f452be9203591991d15f6b388e09e8d0", "0xc473e2aee3441bf9240be85eb122abb059a3b57c"]
  ...
  if (whitelistedPools.includes(event.params.pool.toHexString())) {
